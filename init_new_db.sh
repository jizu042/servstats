...
export PGPASSWORD='H4fQ9oNIZNDrnfHf57002S8OBriHcTn1'

psql -h dpg-d79227vfte5s739dt5s0-a.frankfurt-postgres.render.com -U db_0706_user db_0706 << 'EOF'

-- Создать правильную схему для ServStats
...
echo ""
echo "Теперь:"
echo "1. Обновите DATABASE_URL в Render для API и Worker сервисов"
echo "2. Перезапустите оба сервиса (Manual Deploy)"
echo "3. Подождите 5-10 минут для сбора данных"
